...
def load_android_voice():
    global HAS_ANDROID
    global activity
    global Permission
    global request_permissions
    global Intent
    global RecognizerIntent
    ...
    try:
        ...
        from android.permissions import (
            ...
            request_permissions as android_request_permissions
        )
        ...
        request_permissions = android_request_permissions
        ...
        save_diagnostic_error(
            "ANDROID VOICE LOAD ERROR:\n\n"
...
class JARVISUI(BoxLayout):
    ...
    def open_decoy_chat_panel(
        ...
        if is_fake:
            ...
            self.add_message(
                "Type 'pin' to keep history, or "
                "'unpin' to auto-clear on exit.",
                is_user=False
            )
    ...
    def ask(self):
        ...
        if self.is_secret_mode:
            ...
            if clean_cmd == "pin":
                ...
                self.add_message(
                    "🗑️ Private chat unpinned! "
                    "History will auto-clear on exit.",
                    is_user=False
                )
                return
